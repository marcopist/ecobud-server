...
def get_tink_client_access_token(scope=None):
    ...
    logger.info(url)
    data = {"client_id": TINK_CLIENT_ID, "client_secret": TINK_CLIENT_SECRET, "grant_type": "client_credentials", "scope": scope}
...
def get_user_authorization_code(username):
    ...
    url = TINK_BASE_URL + "/api/v1/authorization-grant/delegate"
